...
type ShowToastReturnType = ReturnType<typeof showToast>;
...
export default {
  info({ content, icon, duration = DEFAULT.DURATION, mask, onClose }: IProps): ShowToastReturnType {
  ...
  customize({ customize, duration = DEFAULT.DURATION, mask, onClose }: IProps): ShowToastReturnType {
